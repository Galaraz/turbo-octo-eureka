...
import FotoBancoDePedidos from '../img/foto-destaque-banco-de-pedidos.jpg';
    ...
    async function handleSubmit() {        
        ...
        if (!existsOrError(formulario.nomecompleto) || !existsOrError(formulario.email) || !existsOrError(formulario.cidade) || !existsOrError(formulario.uf) || !existsOrError(formulario.telefone)) {
            ...
            api.post('',{                    
                ...
                if (resp.data.bancodepedidos.status === 'erro') {
                    notify('erro', resp.data.bancodepedidos.erro);
                } 
                else if (resp.data.bancodepedidos.status === 'sucesso') {
                ...
                <div className="container py-5 font-14 px-4 px-sm-0">
                    ...
                    <div className="row py-4">
                        ...
                        <div className="d-none d-xl-block col-4">
                            <Image src={FotoBancoDePedidos} alt="" />
                        </div>
                                    ...
                                    <div className="col-12 col-md-6 pt-3 pt-md-0 pl-0 pl-md-4 pr-0">
                                        ...
                                        <div className="row mx-0">
                                            ...
                                            <div className="col-12 col-md-6 pb-2 mb-1 px-0">
                                                {/* <Select className="select" classNamePrefix="react-select" defaultValue={formulario.finalidade} onChange={(e) => handleForm({ finalidade: e.value})} placeholder="FINALIDADE" options={finalidade} /> */}
                                            </div>

                                            <div className="col-12 col-md-6 pb-2 mb-1 px-0">
                                                {/* <Select className="select" classNamePrefix="react-select" defaultValue={formulario.tipo} onChange={(e) => handleForm({ tipo: e.value})} placeholder="TIPO DO IMÓVEL" options={tipoImovel} /> */}
                                            </div>
