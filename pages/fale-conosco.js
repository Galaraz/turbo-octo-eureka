...
import FundoFaleConosco from '../img/foto-destaque-banco-de-pedidos.jpg';
...
export default function FaleConosco(props) {
    ...
    async function handleSubmit() {        
        ...
        if (!existsOrError(formulario.nomecompleto) || !existsOrError(formulario.email) || !existsOrError(formulario.cidade) || !existsOrError(formulario.uf) || !existsOrError(formulario.telefone) || !existsOrError(formulario.mensagem)) {
            ...
            //     id: apiId
            // }).then(resp => {                        
            //     if (resp.data.faleconosco.status === 'erro') {
            //         notify('erro', resp.data.faleconosco.erro);
            //     } 
            //     else if (resp.data.faleconosco.status === 'sucesso') {
                ...
                <div className="container py-5 font-14">
                    ...
                    <div className="row py-4">
                        ...
                        <div className="d-none d-xl-block col-4">
                            <Image src={FundoFaleConosco} alt="" />
                        </div>
